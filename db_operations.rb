...
conn.exec("CREATE TABLE Games(Id serial PRIMARY KEY, HomeTeam VARCHAR(20), AwayTeam VARCHAR(20), HomeTeamGoals INT DEFAULT null, AwayTeamGoals INT DEFAULT null, ispremium BOOLEAN DEFAULT FALSE)")
